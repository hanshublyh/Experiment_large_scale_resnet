...
para_path = '../../../'
with open(para_path + 'para1_1.txt', 'r', encoding='utf-8') as f:
    para = f.readlines()
    # print(para)
...
for i in range(epoch_len):  # 分几个进度条显示
    ...
    for i_episode in range(per_len):
        ...
        the_computed_reward = agent.update(transition_dict, 'where', sum(
